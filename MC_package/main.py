...
from utils import remanent_classifier, remanent_mass
from plots import plot_mass, plot_born_times_histogram, plot_mass_histogram, plot_mass_histogram_per_remanent,plot_mass_vs_age,pie_plot,pie_plot_remanets
def main(N_p,Xseed,plots):
    ...
    indicators = remanent_classifier(masses, t_out_ms)

    # Compute the final mass of each star after evolution
    final_mass = remanent_mass(masses, indicators)
    ...
    if plots:
        ...
        plt.figure(figsize=(10, 6))
        plot_mass_vs_age(masses,t_alive,indicators)
